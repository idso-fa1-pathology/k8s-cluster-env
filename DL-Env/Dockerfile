...
RUN apt-get update && apt-get install -y --no-install-recommends \
  ...
  sudo curl wget htop git vim ca-certificates python3.10 python3-pip  \
...
RUN chmod -R 777 /tensorflow_datasets
WORKDIR /.dgl
RUN chmod -R 777 /.dgl
WORKDIR /.local
